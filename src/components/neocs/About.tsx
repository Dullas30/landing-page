...
const pillars = [
  {
    ...
    body: "Many small contributions become one large pool, and that pool buys real, income generating assets held for members.",
    big: true,
  },
  {
    title: "Productive assets",
    body: "Tractors, trucks, solar systems, medical and industrial equipment: things that work, earn and hold value.",
  },
  {
    title: "Enterprise growth",
    body: "Members reach the equipment they need to expand output, win contracts and employ more people.",
  },
  {
    title: "Shared prosperity",
    body: "Earnings flow back as dividends, unit value growth, patronage rewards and welfare support.",
  },
];
          ...
          <div>
            ...
            <Reveal delay={2}>
              <p className="mt-7 max-w-lg text-base leading-relaxed text-muted-foreground">
                The Nigeria Equipment Ownership Cooperative Society is a national platform where
                members save together, own together and grow together. No jargon, no gatekeeping.
                One structured route from everyday contributions to a share in a working asset base
                spanning the country.
              </p>
            </Reveal>
            <Reveal delay={3}>
              <p className="mt-5 max-w-lg text-base leading-relaxed text-muted-foreground">
                Our purpose is simple: turn millions of Nigerians from consumers of equipment into
                owners of it.
              </p>
            </Reveal>
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2">
              {pillars.map((p, i) => (
                ...
                >
                  <h3 className="text-sm font-bold uppercase tracking-wider text-growth">
                    {p.title}
                  </h3>
